...
/// Loads the contributors list bundled with the app. The YAML is generated by
/// the `fetch_contributors` CLI tool (`bin/fetch_contributors.dart`).
class ContributorsRepository {
  static const String defaultAssetPath = "assets/contributors/contributors.yaml";
