...
class SearchBarWidgetState extends State<SearchBarWidget>
  ...
  Widget build(BuildContext context) {
    final SearchBarColors searchBarColors =
        Theme.of(context).extension<SearchBarColors>()!;
    ...
    return Container(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          color: !isOpen ? widget.color : (searchBarColors.backgroundColor),
                ...
                child: AnimatedOpacity(
                  ...
                  child: Container(
                    ...
                    child: TextField(
                      ...
                      style: widget.style ??
                          TextStyle(color: searchBarColors.textColor),
                      cursorColor: searchBarColors.textColor,
                ...
                child: IconButton(
                  ...
                  style: ButtonStyle(
                    iconColor: WidgetStatePropertyAll(
                      isOpen
                          ? searchBarColors.lensIconOpenColor
                          : searchBarColors.lensIconColor,
                    ),
                    overlayColor: WidgetStatePropertyAll(
                      isOpen
                          ? searchBarColors.lensIconOverlayColor
                          : Color(0x19ffffff),
                    ),
